...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
          ...
          <article class="main">
            <div class="rslides_container">
              <ul class="callbacks rslides" id="slider1">
                <li>
                  <iframe width="700" height="390" src="https://www.youtube.com/embed/6_B8pVoANyY" frameborder="0" allowfullscreen></iframe>
                  </li>
          ...
          <div id="circles">
            <img style="border-right: 1px solid;" src="img/circle1.png"><img style="border-right: 1px solid;" src="img/circle2.png"><img src="img/circle3.png">
          </div>
          </article>
