...
function mcImgSlider(i) {
	for (var I = function(a) {
			...
			return c
		}, g = "className", h = "getAttribute", y = "opacity", U = function(a, b) {
			return a[Q](b)
		}, nb = function(a) {
	...
	var yb = function() {
		...
		sb = function() {
			...
			if (a)
				...
				else a.addRule("#" + i.sliderId + " .bgLayer", "position:absolute;width:100%;height:100%;")
		};
	sb();
	var c = "style",
		H = "display",
		...
		K = function(a, b) {
			if (a) {
				a.o = b;
				if (T) a[c].filter = "alpha(opacity=" + b * 100 + ")";
				else a[c][y] = b
			}
		};
	L.a = {
	...
	var G = new L,
		...
		wb = function() {
			...
			if (a.l) f = I(a.l);
			if (f)
				for (var h = U(f, "*"), e = 0; e < h[d]; e++) h[e][g] == "thumb" && n.push(h[e]);
			var c = n[d];
			if (c) {
				while (c--) {
					n[c].on = 0;
	...
	lb.prototype = {
		c: function() {
			...
			else b.e = U(e[b.a], "img")[0];
			if (e[b.a][k] == "A" || e[b.a][g] == "video") e[b.a][c][H] = "block";
		...
		g: function() {
			...
			while (a--) {
				...
				if (e[a][k] == "A" || e[a][g] == "video") e[a][c][H] = a == b.a ? "block" : "none"
			}
		},
		k: function() {
			var a = b.e[h]("alt") || "";
		...
		y: function(a, j, k) {
			...
			if (a == b.a && X && !b.c) {
				...
				if (e[a][g] == "imgLink video") {
					...
					d = e[a][Q]("video");
					if (!d.length) d = e[a][Q]("audio");
					if (d.length && d[0][c][H] == "none") h = 1
				}
				h && this.d(e[a])
			}
	...
	var Z = function() {
		var a = I(i.sliderId);
		if (a && t(a)[d] && a.offsetHeight) j = new lb(a);
		else u(Z, 500)
	};
	Y();
	var Ab = function(c) {
	...
	var Db = function() {
		...
		fb = function(e, c) {
			if (++mb < 20)
				if (!j || typeof tooltip == p) u(function() {
					fb(e, c)
				}, 300);
				else
					for (var b = t(x), a = 0; a < b[d]; a++) b[a].onmouseover = function() {
